...
public class StudentsController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/{studentId}/lessons")
    ResponseEntity<Student> getStudentLessons(@PathVariable Integer studentId, HttpServletRequest request,
                                              HttpServletResponse response) throws IOException{
        return studentService.getStudentLessons(studentId, request, response);
    }
